...
var _bindata = map[string]func() ([]byte, error){
	"conf_tls/ca.crt": conf_tls_ca_crt,
	"conf_tls/client.pem": conf_tls_client_pem,
	"conf_tls/conf.ini": conf_tls_conf_ini,
}
...
var _bintree = &_bintree_t{nil, map[string]*_bintree_t{
	"conf_tls": &_bintree_t{nil, map[string]*_bintree_t{
		"ca.crt": &_bintree_t{conf_tls_ca_crt, map[string]*_bintree_t{
		}},
		"client.pem": &_bintree_t{conf_tls_client_pem, map[string]*_bintree_t{
		}},
		"conf.ini": &_bintree_t{conf_tls_conf_ini, map[string]*_bintree_t{
		}},
	}},
}}
